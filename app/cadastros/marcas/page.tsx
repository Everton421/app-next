...
export default function Marcas() {
    ...
    async function busca() {
        ...
        try {
            const result = await api.get(`/marcas/search`, {
    ...
    function handleClick(codigo: number) {
        router.push(`/cadastros/marcas/${codigo}`)
    }
                    ...
                    <div className="m-2 flex flex-col md:flex-row justify-between">
                        ...
                        <div className="flex items-center gap-2 mt-4 md:mt-0 w-full md:w-auto">
                            <Button
                                ...
                                onClick={() => router.push('/cadastros/marcas/novo')}
                            >
                ...
                <div className="w-full mt-4  h-screen shadow-lg ">
                    ...
                    {dados.length > 0 ? (
                        ...
                        isLoading ? (
                            ...
                            <p className="text-xl text-gray-500   ml-7"> nenhuma marca encontrada!</p>
                    )}
                </div>
            </div>
        </div>

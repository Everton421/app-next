...
export default function Categorias() {
    ...
    async function busca() {
        ...
        try {
            const result = await api.get(`/categorias/search`, {
    ...
    function handleClick(codigo: number) {
        router.push(`/cadastros/categorias/${codigo}`)
    }
                    ...
                    <div className="m-2 flex flex-col md:flex-row justify-between">
                        ...
                        <div className="flex items-center gap-2 mt-4 md:mt-0 w-full md:w-auto">
                            <Button
                                ...
                                onClick={() => router.push('/cadastros/categorias/novo')}
                            >
                ...
                <div className="w-full mt-4  h-screen shadow-lg ">
                    ...
                    {dados.length > 0 ? (
                        ...
                        isLoading ? (
                            ...
                            <p className="text-xl text-gray-500   ml-7"> nenhuma categoria encontrada!</p>
                    )}
                </div>
            </div>
        </div>

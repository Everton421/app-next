...
export default function EditPedido(){
   ...
   const dateService = DateService();
    ...
    return(
        <div className="min-h-screen sm:ml-56 p-2 md:p-4 bg-gray-100 pb-28 md:pb-24"> {/* Padding e padding inferior */}
            ...
            <div className="bg-white p-3 md:p-4 fixed bottom-0 left-0 right-0 sm:ml-56 shadow-md-top border-t border-gray-200"> {/* Ajuste de shadow e border */}

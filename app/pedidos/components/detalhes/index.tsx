...
export default function Detalhes ({ obsPedido, setObsPedido, situacao, setSituacao }:props){
                      ...
                      Situação
                            ...
                            <TableRow   > 
                                 ...
                                 > 
                                   ...
                                   < div className="items-center justify-center flex gap-1" >
                                      <div
                                     className={ situacao == 'FI' ? "bg-orange-500  p-1 rounded-sm text-gray-600"  :  "bg-gray-300  p-1 rounded-sm "  }
                                        >

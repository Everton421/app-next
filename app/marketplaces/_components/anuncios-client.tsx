...
import { SelectProdutoModal } from "./select-produto-modal";
...
export function AnunciosClient({ anunciosIniciais }: { anunciosIniciais: Anuncio[] }) {
    ...
    */
    ...
    const handleSelectProduto = (produto: any, fotos: FotoProduto[]) => {
     ...
     const handleAnuncioSuccess = async () => {
    ...
    return (    
        <div className="min-h-screen flex flex-col sm:ml-56 bg-slate-100">
            ...
            <div className="flex-1 w-full max-w-7xl mx-auto p-4 md:p-8 space-y-8">
                ...
                <AlertDemo content={msgAlert} title="Aviso" visible={visibleAlert} setVisible={setVisibleAlert} action={()=> window.location.reload()}  />

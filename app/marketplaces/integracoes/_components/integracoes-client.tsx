...
export function IntegracoesClient({ integrationsInicial }: { integrationsInicial: IMlIntegration[] }) {
    const api = configApi();
    ...
    const [dataIntegration, setDataIntegration] = useState<IMlIntegration[]>(integrationsInicial);
            ...
            <div className="max-w-6xl mx-auto space-y-8">
                ...
                <div>
                    ...
                    {dataIntegration && dataIntegration.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-16 px-6 bg-white rounded-xl border border-dashed border-slate-200 hover:border-[#ffe600]/50 transition-colors duration-300">
